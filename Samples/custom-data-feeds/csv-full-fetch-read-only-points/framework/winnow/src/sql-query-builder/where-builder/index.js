...
class WhereBuilder {
  ...
  #shouldReplaceObjectIdPredicates() {
    return this.#where?.includes('OBJECTID') && this.#options?.requires_fIdGeneration;
  }
   ...
   * assume ArcGIS clients querying a CDF dataset where OBJECTID is created on the fly
