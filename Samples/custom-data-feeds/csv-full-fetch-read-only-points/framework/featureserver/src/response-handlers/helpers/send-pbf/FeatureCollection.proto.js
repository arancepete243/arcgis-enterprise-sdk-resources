...
$root.esriPBuffer = (function () {
  ...
  esriPBuffer.FeatureCollectionPBuffer = (function () {
    ...
    FeatureCollectionPBuffer.SegmentType = (function () {
      var valuesById = {},
        values = Object.create(valuesById);
      values[(valuesById[0] = 'line')] = 0;
      values[(valuesById[1] = 'arc')] = 1;
      values[(valuesById[2] = 'bezier')] = 2;
      values[(valuesById[3] = 'ellipticArc')] = 3;
      return values;
    })();
    ...
    FeatureCollectionPBuffer.SpatialReference = (function () {
      ...
      SpatialReference.prototype.wkt2 = '';
      ...
      SpatialReference.encode = function encode(message, writer) {
        ...
        if (message.wkt2 != null && Object.hasOwnProperty.call(message, 'wkt2'))
          writer.uint32(50).string(message.wkt2);
        return writer;
      };
      ...
      SpatialReference.verify = function verify(message) {
        ...
        if (message.wkt2 != null && message.hasOwnProperty('wkt2'))
          if (!$util.isString(message.wkt2)) return 'wkt2: string expected';
        return null;
      };
      ...
      SpatialReference.fromObject = function fromObject(object) {
        ...
        if (object.wkt2 != null) message.wkt2 = String(object.wkt2);
        return message;
      };
      ...
      SpatialReference.toObject = function toObject(message, options) {
        ...
        if (message.wkt2 != null && message.hasOwnProperty('wkt2')) object.wkt2 = message.wkt2;
        return object;
      };
    ...
    FeatureCollectionPBuffer.Envelope = (function () {
      ...
      Envelope.prototype.ZMin = null;
      Envelope.prototype.MMin = null;
      Envelope.prototype.ZMax = null;
      Envelope.prototype.MMax = null;

      var $oneOfFields;

      Object.defineProperty(Envelope.prototype, '_ZMin', {
        get: $util.oneOfGetter(($oneOfFields = ['ZMin'])),
        set: $util.oneOfSetter($oneOfFields),
      });

      Object.defineProperty(Envelope.prototype, '_MMin', {
        get: $util.oneOfGetter(($oneOfFields = ['MMin'])),
        set: $util.oneOfSetter($oneOfFields),
      });

      Object.defineProperty(Envelope.prototype, '_ZMax', {
        get: $util.oneOfGetter(($oneOfFields = ['ZMax'])),
        set: $util.oneOfSetter($oneOfFields),
      });

      Object.defineProperty(Envelope.prototype, '_MMax', {
        get: $util.oneOfGetter(($oneOfFields = ['MMax'])),
        set: $util.oneOfSetter($oneOfFields),
      });
      ...
      Envelope.encode = function encode(message, writer) {
        ...
        if (message.MMin != null && Object.hasOwnProperty.call(message, 'MMin'))
          writer.uint32(57).double(message.MMin);
        if (message.ZMax != null && Object.hasOwnProperty.call(message, 'ZMax'))
          writer.uint32(65).double(message.ZMax);
        if (message.MMax != null && Object.hasOwnProperty.call(message, 'MMax'))
          writer.uint32(73).double(message.MMax);
        return writer;
      };
      ...
      Envelope.verify = function verify(message) {
        ...
        if (message.ZMin != null && message.hasOwnProperty('ZMin')) {
          properties._ZMin = 1;
          if (typeof message.ZMin !== 'number') return 'ZMin: number expected';
        }
        if (message.MMin != null && message.hasOwnProperty('MMin')) {
          properties._MMin = 1;
          if (typeof message.MMin !== 'number') return 'MMin: number expected';
        }
        if (message.ZMax != null && message.hasOwnProperty('ZMax')) {
          properties._ZMax = 1;
          if (typeof message.ZMax !== 'number') return 'ZMax: number expected';
        }
        if (message.MMax != null && message.hasOwnProperty('MMax')) {
          properties._MMax = 1;
          if (typeof message.MMax !== 'number') return 'MMax: number expected';
        }
        return null;
      };
      ...
      Envelope.fromObject = function fromObject(object) {
        ...
        if (object.ZMin != null) message.ZMin = Number(object.ZMin);
        if (object.MMin != null) message.MMin = Number(object.MMin);
        if (object.ZMax != null) message.ZMax = Number(object.ZMax);
        if (object.MMax != null) message.MMax = Number(object.MMax);
        return message;
      };
      ...
      Envelope.toObject = function toObject(message, options) {
        ...
        if (message.ZMin != null && message.hasOwnProperty('ZMin')) {
          object.ZMin =
            options.json && !isFinite(message.ZMin) ? String(message.ZMin) : message.ZMin;
          if (options.oneofs) object._ZMin = 'ZMin';
        }
        if (message.MMin != null && message.hasOwnProperty('MMin')) {
          object.MMin =
            options.json && !isFinite(message.MMin) ? String(message.MMin) : message.MMin;
          if (options.oneofs) object._MMin = 'MMin';
        }
        if (message.ZMax != null && message.hasOwnProperty('ZMax')) {
          object.ZMax =
            options.json && !isFinite(message.ZMax) ? String(message.ZMax) : message.ZMax;
          if (options.oneofs) object._ZMax = 'ZMax';
        }
        if (message.MMax != null && message.hasOwnProperty('MMax')) {
          object.MMax =
            options.json && !isFinite(message.MMax) ? String(message.MMax) : message.MMax;
          if (options.oneofs) object._MMax = 'MMax';
        }
        return object;
      };
    ...
    FeatureCollectionPBuffer.Value = (function () {
      ...
      Object.defineProperty(Value.prototype, '_index', {
      ...
      Value.encode = function encode(message, writer) {
        ...
        if (message.nullValue != null && Object.hasOwnProperty.call(message, 'nullValue'))
          writer.uint32(80).bool(message.nullValue);
      ...
      Value.verify = function verify(message) {
        ...
        if (message.nullValue != null && message.hasOwnProperty('nullValue')) {
          if (properties.valueType === 1) return 'valueType: multiple values';
          properties.valueType = 1;
          if (typeof message.nullValue !== 'boolean') return 'nullValue: boolean expected';
        }
      ...
      Value.fromObject = function fromObject(object) {
        ...
        if (object.nullValue != null) message.nullValue = Boolean(object.nullValue);
    ...
    FeatureCollectionPBuffer.Geometry = (function () {
      ...
      Geometry.prototype.ids = $util.emptyArray;
      ...
      Geometry.encode = function encode(message, writer) {
        ...
        if (message.ids != null && message.ids.length) {
          ...
          for (var i = 0; i < message.ids.length; ++i) writer.sint32(message.ids[i]);
          writer.ldelim();
        }
        return writer;
      };
      ...
      Geometry.fromObject = function fromObject(object) {
        ...
        if (object.ids) {
          if (!Array.isArray(object.ids))
            throw TypeError('.esriPBuffer.FeatureCollectionPBuffer.Geometry.ids: array expected');
          message.ids = [];
          for (var i = 0; i < object.ids.length; ++i) message.ids[i] = object.ids[i] | 0;
        }
        return message;
      };
    ...
    FeatureCollectionPBuffer.CurveGeometry = (function () {
      function CurveGeometry(properties) {
        this.parts = [];
        this.segmentSets = [];
        this.coords = [];
        if (properties)
      ...
      CurveGeometry.prototype.geometryType = 0;
      CurveGeometry.prototype.parts = $util.emptyArray;
      CurveGeometry.prototype.segmentSets = $util.emptyArray;
      CurveGeometry.prototype.coords = $util.emptyArray;

      CurveGeometry.create = function create(properties) {
        return new CurveGeometry(properties);
      };

      CurveGeometry.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.geometryType != null && Object.hasOwnProperty.call(message, 'geometryType'))
          writer.uint32(8).int32(message.geometryType);
        if (message.parts != null && message.parts.length) {
          writer.uint32(18).fork();
          for (var i = 0; i < message.parts.length; ++i) writer.uint32(message.parts[i]);
          writer.ldelim();
        }
        if (message.segmentSets != null && message.segmentSets.length)
          for (var i = 0; i < message.segmentSets.length; ++i)
            $root.esriPBuffer.FeatureCollectionPBuffer.SegmentSet.encode(
              message.segmentSets[i],
              writer.uint32(26).fork(),
            ).ldelim();
        if (message.coords != null && message.coords.length) {
          writer.uint32(34).fork();
      ...
      CurveGeometry.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
      };

      CurveGeometry.verify = function verify(message) {
        if (typeof message !== 'object' || message === null) return 'object expected';
        if (message.geometryType != null && message.hasOwnProperty('geometryType'))
          switch (message.geometryType) {
            default:
        ...
        if (message.parts != null && message.hasOwnProperty('parts')) {
          if (!Array.isArray(message.parts)) return 'parts: array expected';
          for (var i = 0; i < message.parts.length; ++i)
            if (!$util.isInteger(message.parts[i])) return 'parts: integer[] expected';
        }
        if (message.segmentSets != null && message.hasOwnProperty('segmentSets')) {
          if (!Array.isArray(message.segmentSets)) return 'segmentSets: array expected';
          for (var i = 0; i < message.segmentSets.length; ++i) {
            var error = $root.esriPBuffer.FeatureCollectionPBuffer.SegmentSet.verify(
              message.segmentSets[i],
            );
            if (error) return 'segmentSets.' + error;
          }
        }
        if (message.coords != null && message.hasOwnProperty('coords')) {
          if (!Array.isArray(message.coords)) return 'coords: array expected';
      ...
      CurveGeometry.fromObject = function fromObject(object) {
        if (object instanceof $root.esriPBuffer.FeatureCollectionPBuffer.CurveGeometry)
          return object;
        var message = new $root.esriPBuffer.FeatureCollectionPBuffer.CurveGeometry();
        switch (object.geometryType) {
          default:
            if (typeof object.geometryType === 'number') {
              message.geometryType = object.geometryType;
        ...
        if (object.parts) {
          if (!Array.isArray(object.parts))
            throw TypeError(
              '.esriPBuffer.FeatureCollectionPBuffer.CurveGeometry.parts: array expected',
            );
          message.parts = [];
          for (var i = 0; i < object.parts.length; ++i) message.parts[i] = object.parts[i] >>> 0;
        }
        if (object.segmentSets) {
          if (!Array.isArray(object.segmentSets))
            throw TypeError(
              '.esriPBuffer.FeatureCollectionPBuffer.CurveGeometry.segmentSets: array expected',
            );
          message.segmentSets = [];
          for (var i = 0; i < object.segmentSets.length; ++i) {
            if (typeof object.segmentSets[i] !== 'object')
              throw TypeError(
                '.esriPBuffer.FeatureCollectionPBuffer.CurveGeometry.segmentSets: object expected',
              );
            message.segmentSets[i] =
              $root.esriPBuffer.FeatureCollectionPBuffer.SegmentSet.fromObject(
                object.segmentSets[i],
              );
          }
        }
        if (object.coords) {
          if (!Array.isArray(object.coords))
            throw TypeError(
              '.esriPBuffer.FeatureCollectionPBuffer.CurveGeometry.coords: array expected',
            );
          message.coords = [];
          for (var i = 0; i < object.coords.length; ++i)
            if ($util.Long)
      ...
      CurveGeometry.toObject = function toObject(message, options) {
        if (!options) options = {};
        var object = {};
        if (options.arrays || options.defaults) {
          object.parts = [];
        ...
        if (message.parts && message.parts.length) {
          object.parts = [];
          for (var j = 0; j < message.parts.length; ++j) object.parts[j] = message.parts[j];
        }
        if (message.segmentSets && message.segmentSets.length) {
          object.segmentSets = [];
          for (var j = 0; j < message.segmentSets.length; ++j)
            object.segmentSets[j] = $root.esriPBuffer.FeatureCollectionPBuffer.SegmentSet.toObject(
              message.segmentSets[j],
              options,
            );
        }
        if (message.coords && message.coords.length) {
      ...
      CurveGeometry.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
      };

      CurveGeometry.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
          typeUrlPrefix = 'type.googleapis.com';
        }
        return typeUrlPrefix + '/esriPBuffer.FeatureCollectionPBuffer.CurveGeometry';
      };

      return CurveGeometry;
    })();

    FeatureCollectionPBuffer.SegmentSet = (function () {
      function SegmentSet(properties) {
        this.parameters = [];
        if (properties)
          for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
            if (properties[keys[i]] != null) this[keys[i]] = properties[keys[i]];
      ...
      SegmentSet.prototype.type = 0;
      SegmentSet.prototype.count = 0;
      SegmentSet.prototype.parameters = $util.emptyArray;

      SegmentSet.create = function create(properties) {
        return new SegmentSet(properties);
      };

      SegmentSet.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        ...
        if (message.parameters != null && message.parameters.length) {
          writer.uint32(26).fork();
          for (var i = 0; i < message.parameters.length; ++i) writer.double(message.parameters[i]);
          writer.ldelim();
        }
        return writer;
      };

      SegmentSet.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
      };

      SegmentSet.verify = function verify(message) {
        if (typeof message !== 'object' || message === null) return 'object expected';
        ...
        if (message.parameters != null && message.hasOwnProperty('parameters')) {
          ...
          for (var i = 0; i < message.parameters.length; ++i)
            if (typeof message.parameters[i] !== 'number') return 'parameters: number[] expected';
        }
        return null;
      };

      SegmentSet.fromObject = function fromObject(object) {
        if (object instanceof $root.esriPBuffer.FeatureCollectionPBuffer.SegmentSet) return object;
        var message = new $root.esriPBuffer.FeatureCollectionPBuffer.SegmentSet();
        switch (object.type) {
          default:
        ...
        if (object.parameters) {
          if (!Array.isArray(object.parameters))
            throw TypeError(
              '.esriPBuffer.FeatureCollectionPBuffer.SegmentSet.parameters: array expected',
            );
          message.parameters = [];
      ...
      SegmentSet.toObject = function toObject(message, options) {
        if (!options) options = {};
        var object = {};
        ...
        if (message.type != null && message.hasOwnProperty('type'))
          object.type =
            options.enums === String
              ? $root.esriPBuffer.FeatureCollectionPBuffer.SegmentType[message.type] === undefined
                ? message.type
                : $root.esriPBuffer.FeatureCollectionPBuffer.SegmentType[message.type]
              : message.type;
        ...
        if (message.parameters && message.parameters.length) {
          ...
          for (var j = 0; j < message.parameters.length; ++j)
            object.parameters[j] =
              options.json && !isFinite(message.parameters[j])
                ? String(message.parameters[j])
                : message.parameters[j];
        }
        return object;
      };

      SegmentSet.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
      };

      SegmentSet.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
          typeUrlPrefix = 'type.googleapis.com';
        }
        return typeUrlPrefix + '/esriPBuffer.FeatureCollectionPBuffer.SegmentSet';
      };
    ...
    FeatureCollectionPBuffer.Feature = (function () {
      ...
      Feature.prototype.curveGeometry = null;
      ...
      Object.defineProperty(Feature.prototype, 'compressedGeometry', {
        get: $util.oneOfGetter(($oneOfFields = ['geometry', 'shapeBuffer', 'curveGeometry'])),
        set: $util.oneOfSetter($oneOfFields),
      });
      ...
      Feature.encode = function encode(message, writer) {
        ...
        if (message.curveGeometry != null && Object.hasOwnProperty.call(message, 'curveGeometry'))
          $root.esriPBuffer.FeatureCollectionPBuffer.CurveGeometry.encode(
      ...
      Feature.verify = function verify(message) {
        ...
        if (message.curveGeometry != null && message.hasOwnProperty('curveGeometry')) {
          if (properties.compressedGeometry === 1) return 'compressedGeometry: multiple values';
          properties.compressedGeometry = 1;
          {
            var error = $root.esriPBuffer.FeatureCollectionPBuffer.CurveGeometry.verify(
              message.curveGeometry,
            );
            if (error) return 'curveGeometry.' + error;
          }
        }
      ...
      Feature.fromObject = function fromObject(object) {
        ...
        if (object.curveGeometry != null) {
          if (typeof object.curveGeometry !== 'object')
            throw TypeError(
              '.esriPBuffer.FeatureCollectionPBuffer.Feature.curveGeometry: object expected',
            );
          message.curveGeometry =
            $root.esriPBuffer.FeatureCollectionPBuffer.CurveGeometry.fromObject(
      ...
      Feature.toObject = function toObject(message, options) {
        ...
        if (message.curveGeometry != null && message.hasOwnProperty('curveGeometry')) {
          object.curveGeometry = $root.esriPBuffer.FeatureCollectionPBuffer.CurveGeometry.toObject(
            message.curveGeometry,
            options,
          );
          if (options.oneofs) object.compressedGeometry = 'curveGeometry';
        }
        return object;
      };
    ...
    FeatureCollectionPBuffer.ObjectIdsResult = (function () {
      ...
      ObjectIdsResult.prototype.exceededTransferLimit = false;
      ...
      ObjectIdsResult.encode = function encode(message, writer) {
        ...
        if (
          ...
          writer.uint32(32).bool(message.exceededTransferLimit);
        return writer;
      };
    ...
    FeatureCollectionPBuffer.ExtentCountResult = (function () {
      function ExtentCountResult(properties) {
        if (properties)
          for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
            if (properties[keys[i]] != null) this[keys[i]] = properties[keys[i]];
      }

      ExtentCountResult.prototype.extent = null;
      ExtentCountResult.prototype.count = null;

      var $oneOfFields;

      Object.defineProperty(ExtentCountResult.prototype, '_count', {
        get: $util.oneOfGetter(($oneOfFields = ['count'])),
        set: $util.oneOfSetter($oneOfFields),
      });

      ExtentCountResult.create = function create(properties) {
        return new ExtentCountResult(properties);
      };

      ExtentCountResult.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
      ...
      ExtentCountResult.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
      };

      ExtentCountResult.verify = function verify(message) {
        if (typeof message !== 'object' || message === null) return 'object expected';
        var properties = {};
        if (message.extent != null && message.hasOwnProperty('extent')) {
          var error = $root.esriPBuffer.FeatureCollectionPBuffer.Envelope.verify(message.extent);
          if (error) return 'extent.' + error;
        }
        if (message.count != null && message.hasOwnProperty('count')) {
          properties._count = 1;
          if (
      ...
      ExtentCountResult.fromObject = function fromObject(object) {
        if (object instanceof $root.esriPBuffer.FeatureCollectionPBuffer.ExtentCountResult)
          return object;
        var message = new $root.esriPBuffer.FeatureCollectionPBuffer.ExtentCountResult();
        if (object.extent != null) {
          if (typeof object.extent !== 'object')
            throw TypeError(
              '.esriPBuffer.FeatureCollectionPBuffer.ExtentCountResult.extent: object expected',
            );
          message.extent = $root.esriPBuffer.FeatureCollectionPBuffer.Envelope.fromObject(
            object.extent,
          );
        }
        if (object.count != null)
      ...
      ExtentCountResult.toObject = function toObject(message, options) {
        if (!options) options = {};
        var object = {};
        if (options.defaults) object.extent = null;
        if (message.extent != null && message.hasOwnProperty('extent'))
          object.extent = $root.esriPBuffer.FeatureCollectionPBuffer.Envelope.toObject(
            message.extent,
            options,
          );
        if (message.count != null && message.hasOwnProperty('count')) {
      ...
      ExtentCountResult.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
      };

      ExtentCountResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
          typeUrlPrefix = 'type.googleapis.com';
        }
        return typeUrlPrefix + '/esriPBuffer.FeatureCollectionPBuffer.ExtentCountResult';
      };

      return ExtentCountResult;
    })();
    ...
    FeatureCollectionPBuffer.QueryResult = (function () {
      ...
      QueryResult.prototype.extentCountResult = null;

      var $oneOfFields;

      Object.defineProperty(QueryResult.prototype, 'Results', {
        get: $util.oneOfGetter(
          ($oneOfFields = ['featureResult', 'countResult', 'idsResult', 'extentCountResult']),
        ),
        set: $util.oneOfSetter($oneOfFields),
      });
      ...
      QueryResult.encode = function encode(message, writer) {
        ...
        if (
          message.extentCountResult != null &&
          Object.hasOwnProperty.call(message, 'extentCountResult')
        )
          $root.esriPBuffer.FeatureCollectionPBuffer.ExtentCountResult.encode(
      ...
      QueryResult.verify = function verify(message) {
        ...
        if (message.extentCountResult != null && message.hasOwnProperty('extentCountResult')) {
          if (properties.Results === 1) return 'Results: multiple values';
          properties.Results = 1;
          {
            var error = $root.esriPBuffer.FeatureCollectionPBuffer.ExtentCountResult.verify(
              message.extentCountResult,
            );
            if (error) return 'extentCountResult.' + error;
          }
        }
        return null;
      };
      ...
      QueryResult.fromObject = function fromObject(object) {
        ...
        if (object.extentCountResult != null) {
          if (typeof object.extentCountResult !== 'object')
            throw TypeError(
              '.esriPBuffer.FeatureCollectionPBuffer.QueryResult.extentCountResult: object expected',
            );
          message.extentCountResult =
            $root.esriPBuffer.FeatureCollectionPBuffer.ExtentCountResult.fromObject(
              object.extentCountResult,
            );
        }
        return message;
      };
      ...
      QueryResult.toObject = function toObject(message, options) {
        ...
        if (message.extentCountResult != null && message.hasOwnProperty('extentCountResult')) {
          object.extentCountResult =
            $root.esriPBuffer.FeatureCollectionPBuffer.ExtentCountResult.toObject(
              message.extentCountResult,
              options,
            );
          if (options.oneofs) object.Results = 'extentCountResult';
        }
        return object;
      };
