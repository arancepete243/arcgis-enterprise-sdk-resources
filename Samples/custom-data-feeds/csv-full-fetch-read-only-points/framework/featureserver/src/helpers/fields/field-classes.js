...
class FieldFromKeyValue extends Field {
  constructor(key, value) {
    ...
    this.alias = key;
    this.sqlType = getSqlTypeFromValue(value);
    this.domain = null;
    this.defaultValue = null;
    this.setLength();
  }
...
class StatisticDateField extends StatisticField {
  constructor(key) {
    ...
    this.sqlType = SQL_TYPE_TIMESTAMP_2;
  }
}
...
class FieldFromFieldDefinition extends Field {
  constructor(fieldDefinition) {
    ...
    this.sqlType = sqlType || getSqlTypeFromDefinition(type);
...
class ObjectIdFieldFromDefinition extends FieldFromFieldDefinition {
  constructor(definition) {
    ...
    this.type = ESRI_FIELD_TYPE_OID;
    this.sqlType =
      definition.type === 'BigInt' || definition.type === 'BigInteger'
        ? 'sqlTypeBigInt'
        : SQL_TYPE_INTEGER;
    delete this.length;
  }
