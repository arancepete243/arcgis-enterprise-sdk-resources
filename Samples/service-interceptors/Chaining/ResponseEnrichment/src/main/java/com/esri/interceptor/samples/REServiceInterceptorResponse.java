 ...
 */
public class REServiceInterceptorResponse extends ServerServicesInterceptorResponseWrapper {
  ...
  public REServiceInterceptorResponse(IInterceptorResponse interceptorResponse) {
